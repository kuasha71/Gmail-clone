#WRITTEN BY Kuasha - 71
#MY GITHUB : https://github.com/kuasha71
#----------import----------#
...
logo=("""
 _   __                _                ________  
| | / /               | |              |___  /  | 
| |/ / _   _  __ _ ___| |__   __ _ ______ / /`| | 
|    \| | | |/ _` / __| '_ \ / _` |______/ /  | | 
| |\  \ |_| | (_| \__ \ | | | (_| |    ./ /  _| |_
\_| \_/\__,_|\__,_|___/_| |_|\__,_|    \_/   \___/  """)
#-----------clear-----------#
def clear():
    clr('clear')
    print(logo)
    print(45*'-')
    print('Facebook : www.facebook.com/jihad.xe')
    print('Github   : kuasha71')
    print(45*'-')
#----------line----------#
def line():
    print(45*'-')
...
def gmail():
    user=[]
    clear()
    print('EXAMPLE : kuasha , jihad , bdmod71 ')
